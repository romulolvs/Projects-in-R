...
# com ênfase em dados multivariados. 

# Na criação de gráficos, condições e agrupamentos são 2 conceitos importantes, que nos permitem
# compreender mais facilmente os dados que temos em mãos. O conceito por trás do Lattice
# é agrupar os dados e criar visualizaçãoes de forma que fique mais fácil a busca por padrões.
