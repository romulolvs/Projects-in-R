...
# 01) Crie uma função que receba os dois vetores como parâmetro, converta-os em um dataframe e imprima no console
vec1 <- (10:13)
vec2 <- c("a","b","c","d")
...
# 02) Crie uma matriz com 4 linhas e 4 colunas preenchida com números inteiros e calcule a média de cada linha
...
# 03) Considere o dataframe abaixo. 
...
# 04) Crie uma lista com 3 elementos, todos numéricos e calcule a soma de todos os elementos da lista
...
# 05) Transforme a lista anterior em um vetor
unlist(lst)

####################################################################################################

# 06) Considere a string abaixo. Substitua a palavra "textos" por "frases"
...
# 07) Usando o dataset mtcars, crie um grafico com ggplot do tipo scatter plot.
...
# 09) Qual o erro do código abaixo?
# Troubleshooting
data(diamonds)
View(diamonds)
...
# 10) Qual o erro do código abaixo?
